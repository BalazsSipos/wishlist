...
namespace wishlist.Services.EventService
{
    public class EventService : IEventService
    {
        ...
        {
            var eventItem = await applicationDbContext.Events.Include(e => e.Gifts).Include(e => e.Invitations).Include(e => e.EventType).Include(e => e.AppUser).FirstOrDefaultAsync(e => e.EventId == eventId);
            if (eventItem == null)
            {
                return null;
            }
